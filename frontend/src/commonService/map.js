...
export default function Map(props){
  ...
  useEffect(()=>{
    ...
    const mymap = L.map("mapid").setView([25.014057657671447, 121.53812819619687], 17); 
    ...
    const marker = L.marker([25.014057657671447, 121.53812819619687], { icon: greenIcon }).addTo(
      mymap
    );
